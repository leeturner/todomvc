 ...
 */
@Singleton
public class HtmxRequestHeadersTypedRequestArgumentBinder implements TypedRequestArgumentBinder<HtmxRequestHeaders> {
    @Override
    ...
    public BindingResult<HtmxRequestHeaders> bind(ArgumentConversionContext<HtmxRequestHeaders> context, HttpRequest<?> request) {
        if (request.getHeaders().get(HtmxRequestHeaders.HX_REQUEST) == null) {
